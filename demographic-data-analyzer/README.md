...
I analyzed demographic data using Pandas. The dataset of demographic data was extracted from the 1994 Census database. Here is a sample of what the data looks like:
...
I also attached a .ipynb file containing the code if you prefer using Notebook.
